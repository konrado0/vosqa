    ...
    def process_authentication_request(self, request):
        try:
            ...
            if "access_token" not in response.keys():
                raise InvalidAuthentication(_("You need to approve our app in order to register with Facebook. If you do not want to do this just register with email."))
            ...
            logging.exception("Problem during Facebook authentication")
            raise InvalidAuthentication(_("Something wrong happened during Facebook authentication, administrators will be notified"))
