...
class UserJoinsAction(ActionProxy):
    ...
    def process_action(self):
        hash = None if self.user.email_isvalid else ValidationHash.objects.create_new(self.user, 'email', [self.user.email])
...
class AwardAction(ActionProxy):
    ...
    def process_action(self):
        ...
        #TODO: Add some kind of notifications about awards
