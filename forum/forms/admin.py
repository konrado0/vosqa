...
class PageForm(forms.Form):
    ...
    render = forms.ChoiceField(widget=forms.RadioSelect, choices=RENDER_CHOICES, initial='html',
                               label=_('Render Mode'))
    ...
    sidebar_render = forms.ChoiceField(widget=forms.RadioSelect, choices=RENDER_CHOICES, initial='html',
