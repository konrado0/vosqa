...
#This is also minimum answer length
...
FORM_MAX_LENGTH_OF_TAG = Setting('FORM_MAX_LENGTH_OF_TAG', 19, FORUM_SET, dict(
label = _("Maximum length of a tag"),
help_text = _("How long a tag can be."),
))

FORM_MAX_NUMBER_OF_CHARACTERS_IN_TOP_TAGS = Setting('FORM_MAX_NUMBER_OF_CHARACTERS_IN_TOP_TAGS', 20, FORUM_SET, dict(
label = _("Maximum number of characters displayed in header on main page"),
help_text = _("How many characters can appear in header."),
))
