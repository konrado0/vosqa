...
PAGES_SET = SettingSet('about', 'About page', "Define the text in the about page. You can use basic html tags.", 2000, True)

ABOUT_PAGE_TEXT = Setting('ABOUT_PAGE_TEXT',
u"""
<h1>Please customize this text in the administration area<h1/>

<p>Here you can **ask** and **answer** questions, **comment**
...
<p>No points are necessary to ask or answer the questions - so please - join us!</p>

<p>If you would like to find out more about this site - please see the **frequently asked questions** page.</p>
""", PAGES_SET, dict(
