...
EMAIL_BORDER_COLOR = Setting('EMAIL_BORDER_COLOR', '#BF1C23', EMAIL_SET, dict(
...
EMAIL_USER_ANCHOR_STYLE = Setting('EMAIL_USER_ANCHOR_STYLE', "text-decoration:none;color:#009999;text-transform:capitalize;font-weight:bold;", EMAIL_SET, dict(
label = _("Email User Link Style"),
help_text = _("A valid css string to be used to style email links to user profiles (the A tag)."),
required=False))

EMAIL_QUESTION_ANCHOR_STYLE = Setting('EMAIL_QUESTION_ANCHOR_STYLE', "text-decoration:none;color:black;font-weight:bold;", EMAIL_SET, dict(
label = _("Email Question Link Style"),
help_text = _("A valid css string to be used to style email links to question (the A tag)."),
required=False))
