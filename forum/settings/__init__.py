...
ALLOWED_IMAGE_TYPES_JS = "|".join(djsettings.ALLOW_FILE_TYPES)
TINYMCE_CONFIG = djsettings.TINYMCE_CONFIG
NEXT_PAGE_LOAD_TRIGGER = djsettings.NEXT_PAGE_LOAD_TRIGGER
