...
CUSTOM_HEADER_RENDER_MODE = Setting('CUSTOM_HEADER_RENDER_MODE', 'html', HEAD_AND_FOOT_SET, dict(
...
ANNOUNCEMENT_BAR_RENDER_MODE = Setting('ANNOUNCEMENT_BAR_RENDER_MODE', 'html', HEAD_AND_FOOT_SET, dict(
...
CUSTOM_FOOTER_RENDER_MODE = Setting('CUSTOM_FOOTER_RENDER_MODE', 'html', HEAD_AND_FOOT_SET, dict(
